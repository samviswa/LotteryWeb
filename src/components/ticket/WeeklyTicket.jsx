        ...
        <div className='ticket'>
          <div className='left'>
            ...
            <div className='w-[450px] p-4 flex mt-[130px] flex-col justify-center items-center -ml-[80px]' ref={ticketRef}>
              <h2 className="text-3xl -mt-[250px] archivo-black-regular ">Weekly Lottery Ticket</h2>
          ...
          <div className='right'>
            ...
            <div className='w-[100%] h-[160px] bg-gradient-to-b from-[#DDD] via-white to-[#DDD] '>
            </div>
            <div className="flex-col justify-center items-center relative top-[30px] left-[50px]">
              ...
              <p className="archivo-black-regular relative top-3 -left-5">WW{ticketCode}</p>
            </div>
