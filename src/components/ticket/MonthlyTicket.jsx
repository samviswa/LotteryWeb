...
const MonthlyTicket = ({ gameName, userName, selectedNumbers, ticketCode, ticketAmount, total }) => {
  ...
  return (
    <>
        ...
        <div className='ticket'>
          <div className='left'>
            ...
            <div className='w-[450px] p-4 flex mt-[130px] flex-col justify-center items-center -ml-[80px]' ref={ticketRef}>
              <h2 className="text-4xl -mt-[250px] title ">Monthly Lottery Ticket</h2>
              ...
              <p className="mb-2 archivo-black-regular"><span className="archivo-black-regular">Total Amount:</span> ₹{total}</p>
          ...
          <div className='right'>
            ...
            <div className='w-[100%] h-[160px] bg-gradient-to-b from-yellow-300 via-white to-yellow-300 '>
            </div>
            <div className="flex-col justify-center items-center relative top-[30px] left-[50px]">
              ...
              <p className="archivo-black-regular relative top-3 -left-5">MM{ticketCode}</p>
            </div>
      ...
      {!downloaded && (
        <div className="flex justify-center relative  left-[300px]">
